            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-slate-300 max-w-md">
                  Join 10,000+ professionals receiving resume tips, job search
          ...
          <div className="py-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-6 gap-8">
              ...
              <div className="xl:col-span-2">
                ...
                >
                  Creating professional, ATS-friendly resumes that help you land
                  your dream job faster. Join thousands of successful
                  professionals who trust Krytil.
                </motion.p>
          ...
          >
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-6 text-slate-300">
                <span>© 2025 Krytil. All rights reserved.</span>
